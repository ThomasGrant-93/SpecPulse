...
export default function SpecDetailPage() {
    ...
    return (
        <HeadersProvider>
                ...
                {specLoading ? (
                        ...
                        >
                            <div className="space-y-4">
                                <div className="text-sm text-gray-600">
                                    Provide credentials for supported security schemes. Stored in
                                    this browser session.
                                </div>

                                {Object.keys(availableSecuritySchemes).length === 0 ? (
                                    <div className="text-sm text-gray-500">
                                        No security schemes found in this specification.
                                    </div>
                                ) : (
                                    <div className="space-y-3">
                                        {Object.entries(availableSecuritySchemes).map(
                                            ([schemeName, schemeDef]) => {
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                        <p className="text-yellow-800">
                            Unable to parse OpenAPI specification. The content may not be valid
                            JSON.
                        </p>
                    </div>
                )}
            ...
            <GlobalHeadersModal
                isOpen={isGlobalHeadersOpen}
                onClose={() => setIsGlobalHeadersOpen(false)}
            />
        </HeadersProvider>
    );
}
