package com.specpulse.version.domain;
...
public class SpecVersionEntity {
    ...
    private com.specpulse.registry.domain.ServiceEntity service;
    ...
    public SpecVersionEntity(com.specpulse.registry.domain.ServiceEntity service,
                              String versionHash,
    ...
    public com.specpulse.registry.domain.ServiceEntity getService() {
        return service;
    }

    public void setService(com.specpulse.registry.domain.ServiceEntity service) {
        this.service = service;
    }
